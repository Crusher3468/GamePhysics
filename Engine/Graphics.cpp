...
void Graphics::CreateWindow(const char* title, int width, int height, float size)
{
	...
	m_window = SDL_CreateWindow(title, SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, m_width, m_height, SDL_WINDOW_SHOWN);
...
void Graphics::DrawLine(const glm::ivec2& point1, const glm::ivec2& point2, const glm::vec4& color)
{
	SetColor(color);
